...
[Lab 02 – Network Security Groups & Application Security Groups](#lab-02--network-security-groups--application-security-groups)  
[Lab 03 – Azure Firewall](#lab-03--azure-firewall)  
[Lab 04 – ACR & AKS Security](#lab-04--azure-container-registry--aks-security)  
[Lab 05 – Service Endpoints & Storage Security](#lab-05--service-endpoints--storage-security)  
[Lab 06 – Log Analytics & Data Collection Rules (DCR)](#lab-06--log-analytics--data-collection-rules)  
[Lab 07 – Microsoft Defender for Cloud](#lab-07--microsoft-defender-for-cloud)  
[Lab 08 – Just-In-Time (JIT) VM Access](#lab-08--just-in-time-jit-vm-access)  
